...
1. As a user, I should see the timer increment every second once the page has loaded. [X]
2. As a user, I can manually increment and decrement the counter using the plus and minus buttons. [X]
3. As a user, I can 'like' an individual number of the counter. I should see count of the number of 'likes' associated with that number. [X]
4. As a user, I can pause the counter, which should  [X]
...
5. As a user, I can leave comments on my gameplay, such as: "Wow, what a fun game this is."  [X]
